...
@Composable
fun ReportScreen(navController: NavController, viewModel: TransactionViewModel = viewModel(), accountViewModel: AccountViewModel = viewModel(),) {
            ...
            TextButton(onClick = { showDialog = true }) {
                Row(horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically) {
                    androidx.compose.material.Text(
                        ...
                        color = if (isDarkTheme) WhiteColor else BlackColor
                    )
                    Spacer(Modifier.width(8.dp))
...
//                       )
//                       Spacer(Modifier.height(16.dp))
//                       com.example.moneyflow_jetpackcompose.component.TransactionList(viewModel,accountViewModel,userId,navController)
//                   }
//                }
//            }
...
fun CategoryItem(category: String, amount: String) {
    ...
    Row(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text(text = category, fontSize = 16.sp, color = if (isDarkTheme) Color.White else Color.Black)
        }
    ...
    Box(modifier=  Modifier.fillMaxWidth(),  contentAlignment = Alignment.Center) {
        ...
        Column(
            ...
            Text(
                ...
                style = TextStyle(
                    color = if (centerTitle == "income") SuccessColor else ErrorColor,
                    fontSize = 22.sp,
